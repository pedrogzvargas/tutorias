...
LOCAL_APPS = [
    "tutorias_itsvc.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "tutorias_itsvc.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "tutorias_itsvc.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "tutorias_itsvc.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "tutorias_itsvc.users.adapters.SocialAccountAdapter"
