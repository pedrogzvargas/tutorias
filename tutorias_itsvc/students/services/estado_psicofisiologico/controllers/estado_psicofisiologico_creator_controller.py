...
from tutorias_itsvc.students.services.estado_psicofisiologico import EstadoPsicofisiologicoCreatorService
...
class EstadoPsicofisiologicoCreatorController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or EstadoPsicofisiologicoCreatorService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in EstadoPsicofisiologicoCreatorController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
