...
class EstadoPsicofisiologicoCreatorService:
    def __init__(self,
    ...
    def __call__(self, student_id, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p8_1=None):
        ...
        if self.__estado_psicofisiologico_repository.get(student_id=student_id):
            raise EstadoPsicofisiologicoAlreadyExist("Ya existe un registro")
        if not student:
            raise StudentNotExist(f"No existe un estudiante con el id {student_id}")
        return self.__estado_psicofisiologico_repository.create(student_id=student_id,
                                                                p1=p1,
                                                                p2=p2,
                                                                p3=p3,
                                                                p4=p4,
