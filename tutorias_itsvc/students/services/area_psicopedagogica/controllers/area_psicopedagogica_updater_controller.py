...
from tutorias_itsvc.students.services.area_psicopedagogica import AreaPsicopedagogicaUpdaterService
...
class AreaPsicopedagogicaUpdaterController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or AreaPsicopedagogicaUpdaterService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in AreaPsicopedagogicaUpdaterController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
