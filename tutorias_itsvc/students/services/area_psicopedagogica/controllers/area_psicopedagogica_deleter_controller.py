...
from tutorias_itsvc.students.services.area_psicopedagogica import AreaPsicopedagogicaDeleterService
...
class AreaPsicopedagogicaDeleterController:
    def __init__(self,
                 response,
        ...
        self.__service = service or AreaPsicopedagogicaDeleterService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in AreaPsicopedagogicaDeleterController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
