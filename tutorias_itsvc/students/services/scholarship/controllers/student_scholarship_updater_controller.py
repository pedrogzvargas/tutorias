...
from tutorias_itsvc.students.services.scholarship import StudentScholarshipUpdaterService
...
class StudentScholarshipUpdaterController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or StudentScholarshipUpdaterService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in StudentScholarshipUpdaterController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
