...
from tutorias_itsvc.students.services.caracteristicas_personales import CaracteristicasPersonalesCreatorService
...
class CaracteristicasPersonalesCreatorController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or CaracteristicasPersonalesCreatorService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in CaracteristicasPersonalesCreatorController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
