...
from tutorias_itsvc.students.services.caracteristicas_personales import CaracteristicasPersonalesUpdaterService
...
class CaracteristicasPersonalesUpdaterController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or CaracteristicasPersonalesUpdaterService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in CaracteristicasPersonalesUpdaterController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
