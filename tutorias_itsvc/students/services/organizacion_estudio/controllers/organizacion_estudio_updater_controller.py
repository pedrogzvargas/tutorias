...
from tutorias_itsvc.students.services.organizacion_estudio import OrganizacionEstudioUpdaterService
...
class OrganizacionEstudioUpdaterController:
    def __init__(self,
                 request,
                 response,
        ...
        self.__service = service or OrganizacionEstudioUpdaterService(
    ...
    def __call__(self, student_id):
        try:
            ...
            log.exception(f"Error in OrganizacionEstudioUpdaterController::__call__, error: {err}")
            response_data = dict(
                success=False,
                message=f"{err}",
            )
