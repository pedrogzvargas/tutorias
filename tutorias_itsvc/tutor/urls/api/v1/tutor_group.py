...
from tutorias_itsvc.tutor.views.api.v1.tutor_group import TutorAdvisedGroupDetailApi
...
urlpatterns = [
    ...
    path("<tutor_id>/group/<advised_group_id>/detail/", TutorAdvisedGroupDetailApi.as_view()),
]
