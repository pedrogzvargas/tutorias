...
class TutorTaughtSubjectDetailApi(APIView):
    permission_classes = [IsAuthenticated, IsTutor | IsAdmin]

    def get(self, request, tutor_id, taught_subject_id):
        ...
        response = getter_controller(id=taught_subject_id, tutor_id=tutor_id)
        return response
